...
vim.schedule(function()
  ...
  -- When running over SSH, use OSC 52 to write to the host terminal's clipboard
...
require('lazy').setup({
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      -- Only ask Mason to install tools not already available in PATH
  ...
  { -- Highlight, edit, and navigate code
    ...
    branch = 'master', -- 'main' is archived experimental API without configs.lua
    build = ':TSUpdate',
